...
class SmartWebView {
	...
	static String ASWV_URL            = "http://sidatang.pakpakbharatkab.go.id/";     // complete URL of your website or offline webpage
	...
	static String ASWV_EXC_LIST       = "github.com,www.google.com,pakpakbharatkab.go.id";              //separate domains with a comma (,)
